...
const EN = {
  ...
  transition: {
    first: 'You chose with what you could see at the time.',
    second: "Now here is what you couldn't see.",
  },
  context: {
    eyebrow: 'THE SAME MORNING',
    title: 'The same seven, with what sat underneath them.',
    owner: 'OWNER',
    decision: 'DECISION',
    status: 'STATUS',
    by: 'BY',
  ...
  mirror: {
    ...
    both: 'Once you could see more, your choices changed.',
    one: 'One choice stayed. One changed once you could see more.',
    none: 'Once you could see more, your choices stayed the same.',
  ...
  pulseback: {
    ...
    quietLead: (name: string, mins: number) =>
      `${name} needed a decision. It had been waiting ${mins} minutes, and you never picked it.`,
    quietName: 'SIGNALFALL',
    quietNone: 'Everything that needed a decision this morning ended up in one of your rounds.',
    quietNote: 'Not a mistake. Two out of seven — something always waits.',
    closingA: 'Someone else may have chosen differently.',
    closingB: 'And their reason would make sense too.',
    cta: 'CONTINUE',
  },
  end: {
    complete: 'PULSE 01 COMPLETE',
    signal: 'SIGNAL',
    signalLine: 'Information that changes what happens next.',
    but: "But what you noticed is not always what is true.",
    next: 'NEXT PULSE',
    truth: 'TRUTH',
    question: 'What do you trust?',
    restart: 'Start again',
    nucleus: 'NUCLEUS',
    experiment: 'An experiment in how we see and decide at work.',
...
const ID: Copy = {
  ...
  transition: {
    first: 'Kamu memilih dengan apa yang kelihatan waktu itu.',
    second: 'Sekarang, ini yang tadi belum kelihatan.',
  },
  context: {
    eyebrow: 'PAGI YANG SAMA',
    title: 'Tujuh yang sama, sekarang dengan latar belakangnya.',
    owner: 'PIC',
    decision: 'KEPUTUSAN',
    status: 'STATUS',
    by: 'DEADLINE',
  ...
  mirror: {
    ...
    both: 'Begitu kamu bisa lihat lebih banyak, pilihanmu berubah.',
    one: 'Satu pilihanmu tetap. Satu lagi berubah begitu kamu tahu konteksnya.',
    none: 'Begitu kamu bisa lihat lebih banyak, pilihanmu tetap sama.',
  ...
  pulseback: {
    ...
    quietLead: (name: string, mins: number) =>
      `${name} butuh keputusan. Sudah menunggu ${mins} menit, tapi tidak pernah kamu pilih.`,
    quietName: 'SIGNALFALL',
    quietNone: 'Semua yang butuh keputusan pagi ini masuk ke salah satu pilihanmu.',
    quietNote: 'Bukan kesalahan. Dua dari tujuh — selalu ada yang menunggu.',
    closingA: 'Orang lain mungkin memilih yang berbeda.',
    closingB: 'Dan alasannya juga masuk akal.',
    cta: 'LANJUT',
  },
  end: {
    complete: 'PULSE 01 SELESAI',
    signal: 'SIGNAL',
    signalLine: 'Informasi yang mengubah langkah berikutnya.',
    but: 'Tapi yang kamu perhatikan belum tentu yang benar.',
    ...
    nucleus: 'NUCLEUS',
    experiment:
      'Eksperimen tentang cara kita melihat dan memutuskan di tempat kerja.',
    share: 'Tantang grup',
    shareText: (first: string, second: string, changed: string) =>
      `*NUCLEUS PULSE 01 — SIGNAL*
